      ...
      <Container>
        <div>
          ...
          <div className={styles.listDiv}>
            ...
            <Link href='/switchmap/create/type' ><a><div className={styles.linkDiv}><Image src='/images/color-palette.png' width={400} height={400} alt='Create type image'/>Estilos</div></a></Link>
