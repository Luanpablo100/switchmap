      ...
      <Container>
        <div>
          ...
          <div className={styles.listDiv}>
            ...
            <Link href='/switchmap/create/group'><a><div className={styles.linkDiv}><Image src='/images/meeting-room.png' width={400} height={400} alt='Create department image'/>Grupo</div></a></Link>
            ...
            <Link href='/switchmap/create/type' ><a><div className={styles.linkDiv}><Image src='/images/network-hub.png' width={400} height={400} alt='Create type image'/>Estilo</div></a></Link>
          </div>
        </div>
      </Container>
  )
